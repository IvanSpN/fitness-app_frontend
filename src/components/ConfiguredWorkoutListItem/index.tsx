...
import { deleteNewExerciseForm, IExercise, setWorkOutForm } from '../ConfiguredWorkoutList/redux/slice'
...
export const ConfiguredWorkoutListItem: React.FC<ConfiguredWorkoutListItemProps> = ({ exercise }) => {
